...
function UserDashboard() {
  ...
  return (
    <div className="my-8 mx-4 md:mx-8 lg:mx-auto p-6 bg-white rounded w-full max-w-6xl shadow-2xl">
      ...
      <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6 text-black">
        {messages.length > 0 ? (
